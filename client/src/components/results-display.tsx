              ...
              dangerouslySetInnerHTML={{
                __html: highlightedText
                  .replace(
                    ...
                    'class="inline-block px-1 rounded text-white bg-pink-500"',
                  )
                  .replace(
                    /class="entity bg-teal-500"/g,
                    'class="inline-block px-1 rounded text-white bg-teal-500"',
                  )
                  .replace(
                  ...
                  .replace(
                    ...
                    'class="inline-block px-1 rounded text-white bg-green-500"',
                  )
                  .replace(
                  ...
                  .replace(
                    ...
                    'class="inline-block px-1 rounded text-white bg-red-500"',
                  )
                  .replace(
                  ...
                  .replace(
                    ...
                    'class="inline-block px-1 rounded text-white bg-blue-500"',
                  ),
              }}
            />
          </CardContent>
